    ...
    <div>
      ...
      <Card>
        <Card.Body>
          ...
          <p>Butcher, J. (2000). Telnet. En J. Butcher (Ed.), Networking technologies (pp. 155-170). London: Routledge.</p>
          <p>Fernández-Navajas, J. (2017). Telemática y redes de comunicaciones. Ediciones Alfaomega.</p>
          <p>Forouzan, B. A. (2014). Data communications and networking (7th ed.). Upper Saddle River, NJ: Pearson Education.</p>
          <p>Garibay, M. T. (2016). Los foros electrónicos como herramienta de aprendizaje. Revista de Educación a Distancia, 20, 1-15.</p>
          <p>Giménez, M., & García, M. (2018). Uso de traductores en línea por parte de estudiantes universitarios. Revista Española de Lingüística Aplicada, 31(2), 41-61.</p>
